...
@section('content')
    ...
    @if (Auth::check())
        <div class="pt-15 w-4/5 m-auto ">
            <a href="/blog/create"
                class="bg-blue-500 uppercase bg-transparent text-gray-100 text-xs py-3 px-5 font-exrabold rounded-3xl ">create
                post</a>
        </div>
    @endif
        ...
        <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200 ">
            ...
            <div>
                ...
                <a href="blog/{{ $post->slug }}"
                    class="uppercase bg-blue-500 text-gray-100 font-extrabold py-4 px-8 rounded-3xl ">keep readng
                </a>
